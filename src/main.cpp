...
int main (int argc, const char *argv[])
{
	...
	cv::Mat originalImage = cv::imread("./../data/o_raindrop0245.jpg", CV_LOAD_IMAGE_COLOR);
	cv::Mat noiseImage = cv::imread("./../data/noise_raindrop0245.jpg", CV_LOAD_IMAGE_COLOR);
	cv::resize(noiseImage, noiseImage, cv::Size(width, height));

	cv::Mat m_image = cv::imread("./../data/m_raindrop0245.jpg", CV_LOAD_IMAGE_COLOR);
	cv::Mat g_image = cv::imread("./../data/g_raindrop0245.jpg", CV_LOAD_IMAGE_COLOR);
	...
	cout << "PSNR o_image: " << cv::PSNR(originalImage, originalImage) << endl;
	...
	cout << "msssim o_image: "<< msssim->compute(originalImage, originalImage) << endl;
	...
	cout << "vifp o_image: " << vifp->compute(originalImage, originalImage) << endl;
